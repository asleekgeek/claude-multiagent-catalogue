...
applyTo: '**/*.tsp'
description: >
  Guidelines and best practices for building TypeSpec-based declarative agents and API
  plugins for Microsoft 365 Copilot
---

> Ported from awesome-copilot/instructions/typespec-m365-copilot.instructions.md
