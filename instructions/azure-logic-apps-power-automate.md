...
description: >
  Guidelines for developing Azure Logic Apps and Power Automate workflows with best
  practices for Workflow Definition Language (WDL), integration patterns, and enterprise
  automation
---

> Ported from awesome-copilot/instructions/azure-logic-apps-power-automate.instructions.md
