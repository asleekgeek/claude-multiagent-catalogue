...
applyTo: '**'
description: >
  Specialized agent for comprehensive .NET framework upgrades with progressive tracking
  and validation
---

> Ported from awesome-copilot/instructions/dotnet-upgrade.instructions.md
