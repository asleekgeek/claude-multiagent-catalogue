...
description: >
  Guidelines and best practices for building Azure Durable Functions in C# using the
  isolated worker model
---

> Ported from awesome-copilot/instructions/azure-durable-functions-csharp.instructions.md
