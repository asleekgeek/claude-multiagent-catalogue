---
applyTo: '**'
description: Dataverse SDK for Python - Pandas Integration Guide
---

> Ported from awesome-copilot/instructions/dataverse-python-pandas-integration.instructions.md
