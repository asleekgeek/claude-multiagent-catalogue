...
description: >
  Best practices for building Next.js (App Router) apps with modern caching, tooling, and
  server/client boundaries (aligned with Next.js 16.1.1).
---

> Ported from awesome-copilot/instructions/nextjs.instructions.md
