...
description: >
  Best practices for Kubernetes YAML manifests including labeling conventions, security
  contexts, pod security, resource management, probes, and validation commands
---

> Ported from awesome-copilot/instructions/kubernetes-manifests.instructions.md
