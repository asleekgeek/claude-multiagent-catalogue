...
description: >
  Guidelines and best practices for building Azure Functions in C# using the isolated
  worker model
---

> Ported from awesome-copilot/instructions/azure-functions-csharp.instructions.md
