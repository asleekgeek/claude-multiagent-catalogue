...
description: >
  Instructions for upgrading .NET MAUI applications from version 9 to version 10,
  including breaking changes, deprecated APIs, and migration strategies for ListView to
  CollectionView.
---

> Ported from awesome-copilot/instructions/dotnet-maui-9-to-dotnet-maui-10-upgrade.instructions.md
