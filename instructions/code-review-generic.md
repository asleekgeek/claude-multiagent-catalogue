...
applyTo: '**'
description: >
  Generic code review instructions that can be customized for any project using Claude
  Code
---

> Ported from awesome-copilot/instructions/code-review-generic.instructions.md
