---
applyTo: '**'
description: Dataverse SDK for Python — Performance & Optimization Guide
---

> Ported from awesome-copilot/instructions/dataverse-python-performance-optimization.instructions.md
