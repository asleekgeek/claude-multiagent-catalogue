...
applyTo: '**/*.php'
description: >
  Best practices for building Model Context Protocol servers in PHP using the official PHP
  SDK with attribute-based discovery and multiple transport options
---

> Ported from awesome-copilot/instructions/php-mcp-server.instructions.md
