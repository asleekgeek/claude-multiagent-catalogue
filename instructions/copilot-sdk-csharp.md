---
applyTo: '**.cs, **.csproj'
description: This file provides guidance on building C# applications using Claude Code SDK.
---

> Ported from awesome-copilot/instructions/copilot-sdk-csharp.instructions.md
