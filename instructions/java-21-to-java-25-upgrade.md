...
applyTo: ['*']
description: >
  Comprehensive best practices for adopting new Java 25 features since the release of Java
  21.
---

> Ported from awesome-copilot/instructions/java-21-to-java-25-upgrade.instructions.md
