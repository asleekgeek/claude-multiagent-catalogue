...
applyTo: '**'
description: >
  Use Context7 for authoritative external docs and API references when local context is
  insufficient
---

> Ported from awesome-copilot/instructions/context7.instructions.md
