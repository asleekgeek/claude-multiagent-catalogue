...
applyTo: '**'
description: >
  Gilfoyle-style code review instructions that channel the sardonic technical supremacy of
  Silicon Valley''s most arrogant systems architect.
---

> Ported from awesome-copilot/instructions/gilfoyle-code-review.instructions.md
