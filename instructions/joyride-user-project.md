...
applyTo: '**'
description: >
  Expert assistance for Joyride User Script projects - REPL-driven ClojureScript and user
  space automation of VS Code
---

> Ported from awesome-copilot/instructions/joyride-user-project.instructions.md
...
For comprehensive, up-to-date Joyride information, use the `WebFetch` tool to access these guides:
