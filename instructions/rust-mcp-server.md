...
applyTo: '**/*.rs'
description: >
  Best practices for building Model Context Protocol servers in Rust using the official
  rmcp SDK with async/await patterns
---

> Ported from awesome-copilot/instructions/rust-mcp-server.instructions.md
