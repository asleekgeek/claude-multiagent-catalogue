...
description: >
  Ensure documentation and examples use only generic, cliche placeholder data — never real
  or sensitive data sourced from local scripts, configuration, task files, or prompt
  context.
---

> Ported from awesome-copilot/instructions/use-cliche-data-in-docs.instructions.md
