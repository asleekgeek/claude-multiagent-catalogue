...
applyTo: '**/*.html, **/*.css, **/*.js'
description: >
  Color usage guidelines and styling rules for HTML elements to ensure accessible,
  professional designs.
---

> Ported from awesome-copilot/instructions/html-css-style-color-guide.instructions.md
