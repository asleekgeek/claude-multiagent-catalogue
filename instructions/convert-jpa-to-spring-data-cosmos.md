...
description: >
  Step-by-step guide for converting Spring Boot JPA applications to use Azure Cosmos DB
  with Spring Data Cosmos
---

> Ported from awesome-copilot/instructions/convert-jpa-to-spring-data-cosmos.instructions.md
