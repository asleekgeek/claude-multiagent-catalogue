...
description: >
  WinUI 3 and Windows App SDK coding guidelines. Prevents common UWP API misuse, enforces
  correct XAML namespaces, threading, windowing, and MVVM patterns for desktop Windows
  apps.
---

> Ported from awesome-copilot/instructions/winui3.instructions.md
