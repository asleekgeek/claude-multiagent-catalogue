...
applyTo: '**'
description: >
  Guidance for Fedora (Red Hat family) systems, dnf workflows, SELinux, and modern systemd
  practices.
---

> Ported from awesome-copilot/instructions/fedora-linux.instructions.md
