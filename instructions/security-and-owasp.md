...
description: >
  ...
  anti-patterns, detection regex, framework-specific fixes for modern web and backend
  frameworks, and AI/LLM security guidance.
---

> Ported from awesome-copilot/instructions/security-and-owasp.instructions.md
