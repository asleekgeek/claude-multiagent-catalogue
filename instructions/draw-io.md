...
description: >
  Use when creating, editing, or reviewing draw.io diagrams and mxGraph XML in .drawio,
  .drawio.svg, or .drawio.png files.
---

> Ported from awesome-copilot/instructions/draw-io.instructions.md
