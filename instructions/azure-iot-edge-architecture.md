...
description: >
  Require Azure IoT Edge documentation review before proposing edge IoT architectures or
  Azure implementation guidance.
---

> Ported from awesome-copilot/instructions/azure-iot-edge-architecture.instructions.md
