...
description: >
  Instructions for implementing task plans with progressive tracking and change record -
  Brought to you by microsoft/edge-ai
---

> Ported from awesome-copilot/instructions/task-implementation.instructions.md
