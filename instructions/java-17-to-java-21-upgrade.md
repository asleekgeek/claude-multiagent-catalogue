...
applyTo: ['*']
description: >
  Comprehensive best practices for adopting new Java 21 features since the release of Java
  17.
---

> Ported from awesome-copilot/instructions/java-17-to-java-21-upgrade.instructions.md
