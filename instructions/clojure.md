...
description: >
  Clojure-specific coding patterns, inline def usage, code block templates, and namespace
  handling for Clojure development.
---

> Ported from awesome-copilot/instructions/clojure.instructions.md
