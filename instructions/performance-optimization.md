...
applyTo: '**'
description: >
  Comprehensive web performance standards based on Core Web Vitals (LCP, INP, CLS), with
  50+ anti-patterns, detection regex, framework-specific fixes for modern web frameworks,
  and modern API guidance.
---

> Ported from awesome-copilot/instructions/performance-optimization.instructions.md
