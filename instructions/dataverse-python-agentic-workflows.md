---
applyTo: '**'
description: Dataverse SDK for Python - Agentic Workflows Guide
---

> Ported from awesome-copilot/instructions/dataverse-python-agentic-workflows.instructions.md
