...
description: >
  Tailwind CSS v4+ installation and configuration for Vite projects using the official
  @tailwindcss/vite plugin
---

> Ported from awesome-copilot/instructions/tailwind-v4-vite.instructions.md
