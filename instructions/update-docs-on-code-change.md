...
description: >
  Automatically update README.md and documentation files when application code changes
  require documentation updates
---

> Ported from awesome-copilot/instructions/update-docs-on-code-change.instructions.md
