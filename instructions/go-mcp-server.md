...
description: >
  Best practices and patterns for building Model Context Protocol (MCP) servers in Go
  using the official github.com/modelcontextprotocol/go-sdk package.
---

> Ported from awesome-copilot/instructions/go-mcp-server.instructions.md
