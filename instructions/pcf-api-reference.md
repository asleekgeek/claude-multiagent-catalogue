...
applyTo: '**/*.{ts,tsx,js}'
description: >
  Complete PCF API reference with all interfaces and their availability in model-driven
  and canvas apps
---

> Ported from awesome-copilot/instructions/pcf-api-reference.instructions.md
