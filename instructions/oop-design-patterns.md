...
description: >
  Best practices for applying Object-Oriented Programming (OOP) design patterns, including
  Gang of Four (GoF) patterns and SOLID principles, to ensure clean, maintainable, and
  scalable code.
---

> Ported from awesome-copilot/instructions/oop-design-patterns.instructions.md
