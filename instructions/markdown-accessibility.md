...
applyTo: '**/*.md'
description: >
  Markdown accessibility guidelines based on GitHub''s 5 best practices for inclusive
  documentation
---

> Ported from awesome-copilot/instructions/markdown-accessibility.instructions.md
