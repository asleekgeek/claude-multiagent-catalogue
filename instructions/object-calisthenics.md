...
applyTo: '**/*.{cs,ts,java}'
description: >
  Enforces Object Calisthenics principles for business domain code to ensure clean,
  maintainable, and robust code
---

> Ported from awesome-copilot/instructions/object-calisthenics.instructions.md
