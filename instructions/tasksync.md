...
applyTo: '**'
description: >
  TaskSync V5 - Allows you to give the agent new instructions or feedback after completing
  a task using terminal while agent is running.
---

> Ported from awesome-copilot/instructions/tasksync.instructions.md
