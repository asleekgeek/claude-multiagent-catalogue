...
description: >
  Power Apps Code Apps development standards and best practices for TypeScript, React, and
  Power Platform integration
---

> Ported from awesome-copilot/instructions/power-apps-code-apps.instructions.md
