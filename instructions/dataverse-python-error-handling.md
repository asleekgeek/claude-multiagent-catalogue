---
applyTo: '**'
description: Dataverse SDK for Python — Error Handling & Troubleshooting Guide
---

> Ported from awesome-copilot/instructions/dataverse-python-error-handling.instructions.md
