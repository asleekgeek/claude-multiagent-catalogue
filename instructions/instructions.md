...
description: Guidelines for creating high-quality custom instruction files for Claude Code
---

> Ported from awesome-copilot/instructions/instructions.instructions.md
