...
applyTo: '*'
description: >
  Foundational instructions covering core DevOps principles, culture (CALMS), and key
  metrics (DORA) to guide Claude Code in understanding and promoting effective software
  delivery.
---

> Ported from awesome-copilot/instructions/devops-core-principles.instructions.md
