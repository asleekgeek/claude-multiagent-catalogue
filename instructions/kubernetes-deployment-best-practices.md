...
description: >
  ...
  Covers Pods, Deployments, Services, Ingress, ConfigMaps, Secrets, health checks,
  resource limits, scaling, and security contexts.
---

> Ported from awesome-copilot/instructions/kubernetes-deployment-best-practices.instructions.md
