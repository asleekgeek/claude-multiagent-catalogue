...
description: >
  Best practices and patterns for building Model Context Protocol (MCP) servers in Ruby
  using the official MCP Ruby SDK gem.
---

> Ported from awesome-copilot/instructions/ruby-mcp-server.instructions.md
