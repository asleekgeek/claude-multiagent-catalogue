---
applyTo: '**'
description: Dataverse SDK for Python — Authentication & Security Patterns
---

> Ported from awesome-copilot/instructions/dataverse-python-authentication-security.instructions.md
