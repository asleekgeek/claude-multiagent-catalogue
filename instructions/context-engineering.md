...
applyTo: '**'
description: >
  Guidelines for structuring code and projects to maximize Claude Code effectiveness
  through better context management
---

> Ported from awesome-copilot/instructions/context-engineering.instructions.md
