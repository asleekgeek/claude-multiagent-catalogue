---
applyTo: "**"
description: Instructions for customizing Claude Code behavior for MONGODB DBA chat mode.
---

> Ported from awesome-copilot/instructions/mongo-dba.instructions.md
