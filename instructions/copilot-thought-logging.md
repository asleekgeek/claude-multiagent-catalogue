...
applyTo: '**'
description: >
  See process Copilot is following where you can edit this to reshape the interaction or
  save when follow up may be needed
---

> Ported from awesome-copilot/instructions/copilot-thought-logging.instructions.md
