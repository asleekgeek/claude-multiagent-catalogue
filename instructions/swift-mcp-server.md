...
description: >
  Best practices and patterns for building Model Context Protocol (MCP) servers in Swift
  using the official MCP Swift SDK package.
---

> Ported from awesome-copilot/instructions/swift-mcp-server.instructions.md
