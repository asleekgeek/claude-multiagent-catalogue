...
description: >
  Production-grade guidance for AWS AppSync Event API handlers using APPSYNC_JS runtime
  restrictions, utilities, modules, and datasource patterns
---

> Ported from awesome-copilot/instructions/aws-appsync.instructions.md
