---
applyTo: "**"
description: Instructions for customizing Claude Code behavior for MS-SQL DBA chat mode.
---

> Ported from awesome-copilot/instructions/ms-sql-dba.instructions.md
