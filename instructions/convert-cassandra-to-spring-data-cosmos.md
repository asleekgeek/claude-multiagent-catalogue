...
description: >
  Step-by-step guide for converting Spring Boot Cassandra applications to use Azure Cosmos
  DB with Spring Data Cosmos
---

> Ported from awesome-copilot/instructions/convert-cassandra-to-spring-data-cosmos.instructions.md
