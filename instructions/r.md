...
description: >
  R language and document formats (R, Rmd, Quarto): coding standards and Copilot guidance
  for idiomatic, safe, and consistent code generation.
---

> Ported from awesome-copilot/instructions/r.instructions.md
