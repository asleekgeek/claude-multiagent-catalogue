---
applyTo: '**'
description: Dataverse SDK for Python — Real-World Use Cases & Templates
---

> Ported from awesome-copilot/instructions/dataverse-python-real-world-usecases.instructions.md
