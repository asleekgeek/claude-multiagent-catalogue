...
description: >
  This file provides guidance on building Node.js/TypeScript applications using Claude
  Code SDK.
---

> Ported from awesome-copilot/instructions/copilot-sdk-nodejs.instructions.md
