...
description: >
  Azure resource naming conventions based on Microsoft CAF (Cloud Adoption Framework). Use
  when creating, reviewing, or suggesting names for Azure resources.
---

> Ported from awesome-copilot/instructions/azure-naming.instructions.md
