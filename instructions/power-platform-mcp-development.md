...
applyTo: '**/*.{json,csx,md}'
description: >
  Instructions for developing Power Platform custom connectors with Model Context Protocol
  (MCP) integration for Microsoft Copilot Studio
---

> Ported from awesome-copilot/instructions/power-platform-mcp-development.instructions.md
