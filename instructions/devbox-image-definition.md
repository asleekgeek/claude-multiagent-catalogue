...
applyTo: '**/*.yaml'
description: >
  Authoring recommendations for creating YAML based image definition files for use with
  Microsoft Dev Box Team Customizations
---

> Ported from awesome-copilot/instructions/devbox-image-definition.instructions.md
