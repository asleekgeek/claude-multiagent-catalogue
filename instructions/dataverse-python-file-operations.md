---
applyTo: '**'
description: Dataverse SDK for Python - File Operations & Practical Examples
---

> Ported from awesome-copilot/instructions/dataverse-python-file-operations.instructions.md
