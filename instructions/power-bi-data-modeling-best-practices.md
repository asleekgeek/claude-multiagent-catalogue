...
description: >
  Comprehensive Power BI data modeling best practices based on Microsoft guidance for
  creating efficient, scalable, and maintainable semantic models using star schema
  principles.
---

> Ported from awesome-copilot/instructions/power-bi-data-modeling-best-practices.instructions.md
