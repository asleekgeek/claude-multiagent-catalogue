# tool-guardian — Claude Code Hook Bundle

> Ported from `awesome-copilot/hooks/tool-guardian` per `copilot-to-claude-multiagent/references/conversion-patterns.md` §14

**Events covered (Claude Code):** PreToolUse

**Upstream events:** preToolUse
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "hooks/tool-guardian/guard-tool.sh",
            "timeout": 10
          }
        ]
      }
