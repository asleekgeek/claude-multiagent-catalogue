# dependency-license-checker — Claude Code Hook Bundle

> Ported from `awesome-copilot/hooks/dependency-license-checker` per `copilot-to-claude-multiagent/references/conversion-patterns.md` §14
