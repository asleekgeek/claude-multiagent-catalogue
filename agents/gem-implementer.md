...
> Ported from awesome-copilot/agents/gem-implementer.agent.md
...
- project linters/type-checkers (`npm run lint`, `tsc --noEmit`, `ruff check`, `mypy`) via `Bash` (syntax only, fast feedback)
