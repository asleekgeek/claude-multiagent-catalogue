...
description: >
  Runtime accessibility specialist for keyboard flows, focus management, dialog
  behavior, form errors, and evidence-backed WCAG validation in the browser.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/accessibility-runtime-tester.agent.md
