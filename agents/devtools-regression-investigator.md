...
description: >
  Browser regression specialist for reproducing broken user flows, collecting console and
  network evidence, and narrowing likely root causes with Chrome DevTools MCP.
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/devtools-regression-investigator.agent.md
