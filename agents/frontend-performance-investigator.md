...
description: >
  ...
  regressions, layout shifts, long tasks, and slow network paths with Chrome DevTools MCP.
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/frontend-performance-investigator.agent.md
