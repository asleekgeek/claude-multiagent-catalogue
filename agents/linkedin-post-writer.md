...
description: >
  Draft and format compelling LinkedIn posts with Unicode bold/italic styling, visual
  separators, and engagement-optimized structure. Transforms raw content, technical
  material, images, or ideas into copy-paste-ready LinkedIn posts.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/linkedin-post-writer.agent.md
