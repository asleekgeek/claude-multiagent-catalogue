...
description: >
  Custom agent for building Python Notebooks in VS Code that demonstrate Azure and AI
  features
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/python-notebook-sample-builder.agent.md
