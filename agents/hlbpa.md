...
name: hlbpa
description: >
  Your perfect AI chat mode for high-level architectural documentation and review. Perfect
  for targeted updates after a story or researching that legacy system when nobody
  remembers what it's supposed to be doing.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/hlbpa.agent.md
...
Model coerced from upstream `'claude-sonnet-4'` → `claude-sonnet-4-6` per `references/model-mapping.md`.
