...
description: >
  Validate user understanding of code, design patterns, and implementation details through
  guided questioning.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/demonstrate-understanding.agent.md
