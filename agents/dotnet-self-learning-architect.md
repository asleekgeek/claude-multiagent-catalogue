...
description: >
  Senior .NET architect for complex delivery: designs .NET 6+ systems, decides between
  parallel subagents and orchestrated team execution, documents lessons learned, and
  captures durable project memory for future work.
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/dotnet-self-learning-architect.agent.md
...
Model coerced from upstream `["GPT-5.3-Codex", "Claude Sonnet 4.6 (copilot)", "Claude Opus 4.6 (copilot)", "Claude Haiku 4.5 (copilot)"]` → `claude-opus-4-6` per `references/model-mapping.md`.
