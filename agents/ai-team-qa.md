...
name: ai-team-qa
description: >
  AI QA engineer agent (Ivy). Use when: testing features, running E2E tests, playtesting,
  filing bug reports, writing test automation, creating QA sign-off documents, or
  verifying bug fixes. Reports bugs as GitHub Issues.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/ai-team-qa.agent.md
