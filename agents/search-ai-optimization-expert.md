...
description: >
  Expert guidance for modern search optimization: SEO, Answer Engine Optimization (AEO),
  and Generative Engine Optimization (GEO) with AI-ready content strategies
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/search-ai-optimization-expert.agent.md
