...
description: >
  Kubernetes operations expert for KubeStellar Console — helps you set up the console,
  configure kc-agent (MCP server), connect clusters, deploy workloads, and query live
  Kubernetes data via AI chat.
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/kubestellar-console.agent.md
