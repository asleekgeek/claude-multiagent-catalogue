...
name: code-tour
description: >
  Expert agent for creating and maintaining VSCode CodeTour files with comprehensive
  schema support and best practices
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/code-tour.agent.md
