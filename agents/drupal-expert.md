...
name: drupal-expert
description: >
  Expert assistant for Drupal development, architecture, and best practices using PHP 8.3+
  and modern Drupal patterns
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/drupal-expert.agent.md
