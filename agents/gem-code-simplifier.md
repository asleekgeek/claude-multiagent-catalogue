...
> Ported from awesome-copilot/agents/gem-code-simplifier.agent.md
...
- project linters/type-checkers (`npm run lint`, `tsc --noEmit`, `ruff check`, `mypy`) via `Bash` for quick feedback
