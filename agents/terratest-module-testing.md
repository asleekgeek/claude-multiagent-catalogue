...
description: >
  Generate and refactor Go Terratest suites for Terraform modules, including CI-safe
  patterns, staged tests, and negative-path validation.
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/terratest-module-testing.agent.md
