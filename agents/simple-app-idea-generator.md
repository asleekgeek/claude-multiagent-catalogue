...
description: >
  Brainstorm and develop new application ideas through fun, interactive questioning until
  ready for specification creation.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/simple-app-idea-generator.agent.md
