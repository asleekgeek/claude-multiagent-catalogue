...
description: >
  Research agent that searches scientific papers and retrieves structured experimental
  data from full-text studies using the BGPT MCP server.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/scientific-paper-research.agent.md
