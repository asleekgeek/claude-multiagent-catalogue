...
> Ported from awesome-copilot/agents/gem-documentation-writer.agent.md
...
- project linters/type-checkers (`npm run lint`, `tsc --noEmit`, `ruff check`, `mypy`) via `Bash` for issues
