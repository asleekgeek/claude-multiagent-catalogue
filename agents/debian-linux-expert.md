...
description: >
  Debian Linux specialist focused on stable system administration, apt-based package
  management, and Debian policy-aligned practices.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/debian-linux-expert.agent.md
