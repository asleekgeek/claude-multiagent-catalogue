...
description: >
  Terraform-focused agent that reviews and creates safer IaC changes with emphasis on
  state safety, least privilege, module patterns, drift detection, and plan/apply
  discipline
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/terraform-iac-reviewer.agent.md
