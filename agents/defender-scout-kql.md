...
description: >
  Generates, validates, and optimizes KQL queries for Microsoft Defender XDR Advanced
  Hunting across Endpoint, Identity, Office 365, Cloud Apps, and Identity.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/defender-scout-kql.agent.md
