...
description: >
  Identify and fix production issues by correlating New Relic observability data with code
  changes. Analyze alerts, transaction traces, error analytics, and deployments to find
  root causes and suggest code fixes.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/new-relic-incident-response.agent.md
...
Model coerced from upstream `- GPT-4.1 - GPT-5.4 - Claude Sonnet 4.6` → `claude-sonnet-4-6` per `references/model-mapping.md`.
