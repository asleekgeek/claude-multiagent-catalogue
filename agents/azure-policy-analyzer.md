...
description: >
  Analyze Azure Policy compliance posture (NIST SP 800-53, MCSB, CIS, ISO 27001, PCI DSS,
  SOC 2), auto-discover scope, and return a structured single-pass risk report with
  evidence and remediation commands.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/azure-policy-analyzer.agent.md
