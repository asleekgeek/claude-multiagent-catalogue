...
name: nuxt-expert
description: >
  Expert Nuxt developer specializing in Nuxt 3, Nitro, server routes, data fetching
  strategies, and performance optimization with Vue 3 and TypeScript
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/nuxt-expert.agent.md
