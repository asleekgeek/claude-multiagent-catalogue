...
description: >
  CentOS (Stream/Legacy) Linux specialist focused on RHEL-compatible administration,
  yum/dnf workflows, and enterprise hardening.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/centos-linux-expert.agent.md
