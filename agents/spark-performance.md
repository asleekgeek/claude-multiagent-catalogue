...
description: >
  Diagnose PySpark performance bottlenecks, distributed execution pitfalls, and suggest
  Spark-native rewrites and safer distributed patterns (incl. mapInPandas guidance).
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/spark-performance.agent.md
