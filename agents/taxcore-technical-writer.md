...
description: >
  A domain-expert technical writer for the TaxCore electronic fiscal invoicing ecosystem.
  Use this agent to create, improve, or review documentation for TaxCore applications —
  including the Secure Element Reader, smart card workflows, fiscal invoicing concepts,
  audit processes, and PKI/SE security topics. Covers end-user guides, developer docs,
  reference material, and setup guides across all TaxCore-related surfaces.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/taxcore-technical-writer.agent.md
...
Model coerced from upstream `"claude-sonnet-4.6"` → `claude-sonnet-4-6` per `references/model-mapping.md`.
