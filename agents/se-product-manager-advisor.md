...
description: >
  Product management guidance for creating GitHub issues, aligning business value with
  user needs, and making data-driven product decisions
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/se-product-manager-advisor.agent.md
