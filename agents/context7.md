...
name: context7
description: >
  Expert in latest library versions, best practices, and correct syntax using up-to-date
  documentation
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/context7.agent.md
...
Use the agent/the Task tool tool to execute the workflow efficiently.
