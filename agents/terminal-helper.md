...
> Ported from awesome-copilot/agents/terminal-helper.agent.md
...
Model coerced from upstream `GPT-4.1 (copilot)` → `claude-sonnet-4-6` per `references/model-mapping.md`.
