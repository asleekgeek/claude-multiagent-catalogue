...
description: >
  Transform requirements documents into structured Jira epics and user stories with
  intelligent duplicate detection, change management, and user-approved creation workflow.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/atlassian-requirements-to-jira.agent.md
