...
description: >
  Provide expert C++ software engineering guidance using modern C++ and industry best
  practices.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/expert-cpp-software-engineer.agent.md
