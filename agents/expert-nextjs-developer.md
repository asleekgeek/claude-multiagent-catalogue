...
description: >
  Expert Next.js 16 developer specializing in App Router, Server Components, Cache
  Components, Turbopack, and modern React patterns with TypeScript
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/expert-nextjs-developer.agent.md
