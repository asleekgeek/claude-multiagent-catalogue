...
description: >
  Design Azure IoT and Smart City architectures with clear platform engineering reasoning,
  requiring mandatory review of Azure IoT Edge documentation before recommending edge
  solutions.
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/azure-smart-city-iot-architect.agent.md
...
Model coerced from upstream `'GPT-5.3-Codex'` → `claude-opus-4-6` per `references/model-mapping.md`.
