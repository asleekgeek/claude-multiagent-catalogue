...
description: >
  ...
  complete project modernization with architectural recommendations.
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/modernization.agent.md
...
The agent will:
- Use TodoManager to track workflow stages (9 major steps + sub-tasks)
...
Model coerced from upstream `'GPT-5'` → `claude-opus-4-6` per `references/model-mapping.md`.
