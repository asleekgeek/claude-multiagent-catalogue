...
description: >
  ...
  Execute systematically and specification-driven. Document comprehensively. Operate
  autonomously and adaptively.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/software-engineer-agent-v1.agent.md
