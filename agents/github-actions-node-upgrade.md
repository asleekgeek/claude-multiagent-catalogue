...
description: >
  Upgrade a GitHub Actions JavaScript/TypeScript action to a newer Node runtime version
  (e.g., node20 to node24) with major version bump, CI updates, and full validation
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/github-actions-node-upgrade.agent.md
