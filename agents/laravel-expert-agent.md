...
description: >
  Expert Laravel development assistant specializing in modern Laravel 12+ applications
  with Eloquent, Artisan, testing, and best practices
model: claude-opus-4-6
---

> Ported from awesome-copilot/agents/laravel-expert-agent.agent.md
...
Model coerced from upstream `GPT-4.1 | 'gpt-5' | 'Claude Sonnet 4.5'` → `claude-opus-4-6` per `references/model-mapping.md`.
