...
description: >
  Provide expert Salesforce Platform guidance, including Apex Enterprise Patterns, LWC,
  integration, and Aura-to-LWC migration.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/salesforce-expert.agent.md
