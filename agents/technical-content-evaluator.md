...
description: >
  Elite technical content editor and curriculum architect for evaluating technical
  training materials, documentation, and educational content. Reviews for technical
  accuracy, pedagogical excellence, content flow, code validation, and ensures A-grade
  quality standards.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/agents/technical-content-evaluator.agent.md
...
Model coerced from upstream `Claude Sonnet 4.5 (copilot)` → `claude-sonnet-4-6` per `references/model-mapping.md`.
