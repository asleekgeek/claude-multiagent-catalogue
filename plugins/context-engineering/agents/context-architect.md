...
description: >
  An agent that helps plan and execute multi-file changes by identifying relevant context
  and dependencies
model: claude-opus-4-6
---

> Ported from awesome-copilot/plugins/context-engineering/agents/context-architect.md
