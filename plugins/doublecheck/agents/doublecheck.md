...
name: doublecheck
description: >
  Interactive verification agent for AI-generated output. Runs a three-layer pipeline
  (self-audit, source verification, adversarial review) and produces structured reports
  with source links for human review.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/doublecheck/agents/doublecheck.md
