# doublecheck — Claude Code Port

> Ported from `awesome-copilot/plugins/doublecheck` v1.0.0
...
**Keywords:** `verification`, `hallucination`, `fact-check`, `source-citation`, `trust`, `safety`

## Agents

| Agent | Model | Role |
|---|---|---|
| `agents/doublecheck.md` | `claude-sonnet-4-6` | Interactive verification agent for AI-generated output. Runs a three-layer pipeline (self-audit, source verification, ad |
