# openapi-to-application-nodejs-nestjs — Claude Code Port

> Ported from `awesome-copilot/plugins/openapi-to-application-nodejs-nestjs` v1.0.0
...
**Keywords:** `openapi`, `code-generation`, `api`, `nodejs`, `typescript`, `nestjs`
