# typescript-mcp-development — Claude Code Port

> Ported from `awesome-copilot/plugins/typescript-mcp-development` v1.0.0
...
**Keywords:** `typescript`, `mcp`, `model-context-protocol`, `nodejs`, `server-development`

## Agents

| Agent | Model | Role |
|---|---|---|
| `agents/typescript-mcp-expert.md` | `claude-sonnet-4-6` | Expert assistant for developing Model Context Protocol (MCP) servers in TypeScript |
