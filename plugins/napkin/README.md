# napkin — Claude Code Port

> Ported from `awesome-copilot/plugins/napkin` v1.0.0
> Original author: Awesome Copilot Community | License: MIT | Converted: 2026-05-19

Visual whiteboard collaboration for Copilot CLI. Opens an interactive whiteboard in your browser where you can draw, sketch, and add sticky notes — then share everything back with Copilot. Copilot sees your drawings and responds with analysis, suggestions, and ideas.

**Keywords:** `whiteboard`, `visual`, `collaboration`, `brainstorming`, `non-technical`, `drawing`, `sticky-notes`, `accessibility`, `copilot-cli`, `ux`
