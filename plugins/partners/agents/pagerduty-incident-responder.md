...
description: >
  Responds to PagerDuty incidents by analyzing incident context, identifying recent code
  changes, and suggesting fixes via GitHub PRs.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/pagerduty-incident-responder.md
