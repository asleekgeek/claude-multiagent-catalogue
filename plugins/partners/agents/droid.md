...
name: droid
description: >
  Provides installation guidance, usage examples, and automation patterns for the Droid
  CLI, with emphasis on droid exec for CI/CD and non-interactive automation
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/droid.md
...
Model coerced from upstream `"claude-sonnet-4-5-20250929"` → `claude-sonnet-4-6` per `references/model-mapping.md`.
