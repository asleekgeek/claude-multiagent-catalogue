...
name: comet-opik
description: >
  Unified Comet Opik agent for instrumenting LLM apps, managing prompts/projects, auditing
  prompts, and investigating traces/metrics via the latest Opik MCP server.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/comet-opik.md
