...
description: >
  This custom agent uses Amplitude's MCP tools to deploy new experiments inside of
  Amplitude, enabling seamless variant testing capabilities and rollout of product
  features.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/amplitude-experiment-implementation.md
