...
name: jfrog-sec
description: >
  The dedicated Application Security agent for automated security remediation. Verifies
  package and version compliance, and suggests vulnerability fixes using JFrog security
  intelligence.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/jfrog-sec.md
