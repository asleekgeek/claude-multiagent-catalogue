...
description: >
  Generate release notes for a release in Octopus Deploy. The tools for this MCP server
  provide access to the Octopus Deploy APIs.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/octopus-deploy-release-notes-mcp.md
