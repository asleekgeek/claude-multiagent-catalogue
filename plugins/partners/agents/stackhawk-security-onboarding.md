...
description: >
  Automatically set up StackHawk security testing for your repository with generated
  configuration and GitHub Actions workflow
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/stackhawk-security-onboarding.md
