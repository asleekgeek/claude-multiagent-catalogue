...
description: >
  Identify and fix slow Postgres queries automatically using Neon's branching workflow.
  Analyzes execution plans, tests optimizations in isolated database branches, and
  provides clear before/after performance metrics with actionable code fixes.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/neon-optimization-analyzer.md
