...
description: >
  Expert agent for integrating Apify Actors into codebases. Handles Actor selection,
  workflow design, implementation across JavaScript/TypeScript and Python, testing, and
  production-ready deployment.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/apify-integration-expert.md
