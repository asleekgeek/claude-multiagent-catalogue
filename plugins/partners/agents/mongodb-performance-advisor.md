...
description: >
  Analyze MongoDB database performance, offer query and index optimization insights and
  provide actionable recommendations to improve overall usage of the database.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/mongodb-performance-advisor.md
