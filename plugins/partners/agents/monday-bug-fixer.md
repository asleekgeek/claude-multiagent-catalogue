...
description: >
  Elite bug-fixing agent that enriches task context from Monday.com platform data. Gathers
  related items, docs, comments, epics, and requirements to deliver production-quality
  fixes with comprehensive PRs.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/partners/agents/monday-bug-fixer.md
