# flowstudio-power-automate — Claude Code Port

> Ported from `awesome-copilot/plugins/flowstudio-power-automate` v2.0.0
...
**Keywords:** `power-automate`, `power-platform`, `flowstudio`, `mcp`, `model-context-protocol`, `cloud-flows`, `workflow-automation`, `monitoring`, `governance`
