# automate-this — Claude Code Port

> Ported from `awesome-copilot/plugins/automate-this` v1.0.0
> Original author: Awesome Copilot Community | License: MIT | Converted: 2026-05-19

Record your screen doing a manual process, drop the video on your Desktop, and let Copilot CLI analyze it frame-by-frame to build working automation scripts. Supports narrated recordings with audio transcription.

**Keywords:** `automation`, `screen-recording`, `workflow`, `video-analysis`, `process-automation`, `scripting`, `productivity`, `copilot-cli`
