...
description: >
  Expert Power BI report design and visualization guidance using Microsoft best practices
  for creating effective, performant, and user-friendly reports and dashboards.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/power-bi-development/agents/power-bi-visualization-expert.md
