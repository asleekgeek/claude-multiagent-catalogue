...
description: >
  Expert Power BI data modeling guidance using star schema principles, relationship
  design, and Microsoft best practices for optimal model performance and usability.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/power-bi-development/agents/power-bi-data-modeling-expert.md
