...
description: >
  Expert Power BI performance optimization guidance for troubleshooting, monitoring, and
  improving the performance of Power BI models, reports, and queries.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/power-bi-development/agents/power-bi-performance-expert.md
