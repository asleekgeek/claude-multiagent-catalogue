...
name: modernize-java
description: >
  Upgrades Java projects to target versions (e.g., Java 21, Spring Boot 3.2) via
  incremental planning and execution. Use this agent for all Java upgrade requests.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/modernize-java/agents/modernize-java.md
