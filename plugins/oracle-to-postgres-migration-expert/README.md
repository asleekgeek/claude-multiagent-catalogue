# oracle-to-postgres-migration-expert — Claude Code Port

> Ported from `awesome-copilot/plugins/oracle-to-postgres-migration-expert` v1.0.0
...
**Keywords:** `oracle`, `postgresql`, `database-migration`, `dotnet`, `sql`, `migration`, `integration-testing`, `stored-procedures`

## Agents

| Agent | Model | Role |
|---|---|---|
| `agents/oracle-to-postgres-migration-expert.md` | `claude-sonnet-4-6` | Agent for Oracle-to-PostgreSQL application migrations. Educates users on migration concepts, pitfalls, and best practice |

## Skills

- `skills/creating-oracle-to-postgres-master-migration-plan/SKILL.md`
- `skills/creating-oracle-to-postgres-migration-bug-report/SKILL.md`
- `skills/creating-oracle-to-postgres-migration-integration-tests/SKILL.md`
- `skills/migrating-oracle-to-postgres-stored-procedures/SKILL.md`
...
- `skills/scaffolding-oracle-to-postgres-migration-test-project/SKILL.md`
