...
name: go-mcp-expert
description: >
  Expert assistant for building Model Context Protocol (MCP) servers in Go using the
  official SDK.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/go-mcp-development/agents/go-mcp-expert.md
