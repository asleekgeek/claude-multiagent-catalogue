...
description: >
  Expert assistant for building Model Context Protocol (MCP) servers in Kotlin using the
  official SDK.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/kotlin-mcp-development/agents/kotlin-mcp-expert.md
