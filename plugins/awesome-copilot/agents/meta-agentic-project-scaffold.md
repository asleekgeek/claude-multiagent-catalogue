...
description: >
  Meta agentic project creation assistant to help users create and manage project
  workflows effectively.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/awesome-copilot/agents/meta-agentic-project-scaffold.md
