# power-platform-architect — Claude Code Port

> Ported from `awesome-copilot/plugins/power-platform-architect` v1.0.0
> Original author: Tim Hanewich | License: MIT | Converted: 2026-05-19
...
**Keywords:** `power-platform`, `power-platform-architect`, `power-apps`, `dataverse`, `power-automate`, `power-pages`, `power-bi`

## Skills

- `skills/power-platform-architect/SKILL.md`
