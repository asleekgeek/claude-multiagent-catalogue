...
name: tdd-red
description: >
  Guide test-first development by writing failing tests that describe desired behaviour
  from GitHub issue context before implementation exists.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/testing-automation/agents/tdd-red.md
