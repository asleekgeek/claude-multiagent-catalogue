# context-matic — Claude Code Port

> Ported from `awesome-copilot/plugins/context-matic` v0.1.0
> Original author: APIMatic <developer@apimatic.io> | License: MIT | Converted: 2026-05-19
...
**Keywords:** `api-context`, `api-integration`, `mcp`, `sdk`, `apimatic`, `third-party-apis`, `sdks`
