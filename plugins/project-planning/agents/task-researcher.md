...
description: >
  Task research specialist for comprehensive project analysis - Brought to you by
  microsoft/edge-ai
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/project-planning/agents/task-researcher.md
