...
name: plan
description: >
  Strategic planning and architecture assistant focused on thoughtful analysis before
  implementation. Helps developers understand codebases, clarify requirements, and develop
  comprehensive implementation strategies.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/project-planning/agents/plan.md
