...
name: prd
description: >
  Generate a comprehensive Product Requirements Document (PRD) in Markdown, detailing user
  stories, acceptance criteria, technical considerations, and metrics. Optionally create
  GitHub issues upon user confirmation.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/project-planning/agents/prd.md
