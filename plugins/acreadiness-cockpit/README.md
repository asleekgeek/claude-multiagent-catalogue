# acreadiness-cockpit — Claude Code Port

> Ported from `awesome-copilot/plugins/acreadiness-cockpit` v1.0.0
> Original author: mvanderbend-msoft | License: MIT | Converted: 2026-05-19
...
**Keywords:** `agentrc`, `ai-readiness`, `copilot-instructions`, `readiness-report`, `monorepo`, `policy`, `dashboard`

## Agents

| Agent | Model | Role |
|---|---|---|
| `agents/ai-readiness-reporter.md` | `claude-sonnet-4-6` | Runs the AgentRC readiness assessment on the current repository and produces a self-contained, static HTML dashboard at  |
