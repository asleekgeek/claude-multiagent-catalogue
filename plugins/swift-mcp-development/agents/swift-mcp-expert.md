...
description: >
  Expert assistance for building Model Context Protocol servers in Swift using modern
  concurrency features and the official MCP Swift SDK.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/swift-mcp-development/agents/swift-mcp-expert.md
