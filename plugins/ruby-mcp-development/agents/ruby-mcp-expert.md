...
description: >
  Expert assistance for building Model Context Protocol servers in Ruby using the official
  MCP Ruby SDK gem with Rails integration.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/ruby-mcp-development/agents/ruby-mcp-expert.md
