...
name: php-mcp-expert
description: >
  Expert assistant for PHP MCP server development using the official PHP SDK with
  attribute-based discovery
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/php-mcp-development/agents/php-mcp-expert.md
