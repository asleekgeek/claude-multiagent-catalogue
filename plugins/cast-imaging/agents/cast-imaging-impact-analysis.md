...
description: >
  Specialized agent for comprehensive change impact assessment and risk analysis in
  software systems using CAST Imaging
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/cast-imaging/agents/cast-imaging-impact-analysis.md
