...
description: >
  Specialized agent for identifying, analyzing, and providing remediation guidance for
  code quality issues using CAST Imaging
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/cast-imaging/agents/cast-imaging-structural-quality-advisor.md
