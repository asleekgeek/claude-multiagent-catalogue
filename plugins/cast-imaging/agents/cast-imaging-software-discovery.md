...
description: >
  Specialized agent for comprehensive software application discovery and architectural
  mapping through static code analysis using CAST Imaging
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/cast-imaging/agents/cast-imaging-software-discovery.md
