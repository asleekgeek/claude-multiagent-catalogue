...
description: >
  Implement business automation using Salesforce Flow following declarative automation
  best practices.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/salesforce-development/agents/salesforce-flow.md
