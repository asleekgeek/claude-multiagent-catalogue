...
description: >
  Implement Visualforce pages and controllers following Salesforce MVC architecture and
  best practices.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/salesforce-development/agents/salesforce-visualforce.md
