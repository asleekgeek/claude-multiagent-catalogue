...
description: >
  Implement Salesforce UI components using Lightning Web Components and Aura components
  following Lightning framework best practices.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/salesforce-development/agents/salesforce-aura-lwc.md
