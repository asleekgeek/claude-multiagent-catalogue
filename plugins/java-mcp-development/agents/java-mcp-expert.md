...
description: >
  Expert assistance for building Model Context Protocol servers in Java using reactive
  streams, the official MCP Java SDK, and Spring Boot integration.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/java-mcp-development/agents/java-mcp-expert.md
