...
description: >
  Expert assistant for Rust MCP server development using the rmcp SDK with tokio async
  runtime
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/rust-mcp-development/agents/rust-mcp-expert.md
