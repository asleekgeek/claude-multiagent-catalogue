...
description: >
  Expert React 19.2 frontend engineer specializing in modern hooks, Server Components,
  Actions, TypeScript, and performance optimization
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/frontend-web-dev/agents/expert-react-frontend-engineer.md
