...
description: >
  Code Review Mode tailored for Electron app with Node.js backend (main), Angular frontend
  (render), and native integration layer (e.g., AppleScript, shell, or native tooling).
  Services in other repos are not reviewed here.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/frontend-web-dev/agents/electron-angular-native.md
