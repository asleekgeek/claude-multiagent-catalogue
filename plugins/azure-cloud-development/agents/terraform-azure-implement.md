...
description: >
  Act as an Azure Terraform Infrastructure as Code coding specialist that creates and
  reviews Terraform for Azure resources.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/azure-cloud-development/agents/terraform-azure-implement.md
