...
> Ported from awesome-copilot/plugins/azure-cloud-development/agents/azure-logic-apps-expert.md
...
Model coerced from upstream `"gpt-4"` → `claude-sonnet-4-6` per `references/model-mapping.md`.
