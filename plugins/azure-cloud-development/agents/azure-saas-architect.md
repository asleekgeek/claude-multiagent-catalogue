...
description: >
  Provide expert Azure SaaS Architect guidance focusing on multitenant applications using
  Azure Well-Architected SaaS principles and Microsoft best practices.
model: claude-sonnet-4-6
---

> Ported from awesome-copilot/plugins/azure-cloud-development/agents/azure-saas-architect.md
