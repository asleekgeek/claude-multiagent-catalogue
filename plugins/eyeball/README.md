# eyeball — Claude Code Port

> Ported from `awesome-copilot/plugins/eyeball` v1.0.0
...
**Keywords:** `document-analysis`, `citation-verification`, `screenshot`, `contracts`, `legal`, `trust`, `visual-verification`
